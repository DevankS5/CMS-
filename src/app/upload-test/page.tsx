export default function UploadTest() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <button onClick={checkAPI} style={{ margin: '10px', padding: '10px', background: 'blue', color: 'white' }}>
        Check API Status
      </button>
      
      <form onSubmit={handleUpload} style={{ margin: '20px 0' }}>
        <input type="file" name="file" accept="image/*" required />
        <button type="submit" style={{ margin: '10px', padding: '10px', background: 'green', color: 'white' }}>
          Upload Image
        </button>
      </form>
